        ...
        <div class="container-fixed page-body-wrapper">
            <div class="content-wrapper" style="background-color: white;">
                <div class="page-header">
                    <h3 class="page-title" style="font-size:20px;"> <br> Pendapatan Penjualan Berdasarkan Kota </h3>
                </div>
                <div class="row">
                    <div id="barchart" class="grafik"></div>
                    <p class="highcharts-description" style="font-size:14px; text-align:center;"> <br>
                        <!-- Berikut merupakan grafik untuk menampilkan data pendapatan per-kota. Pendapatan yang
                        didapatkan berasal dari penjualan setiap toko. Berdasarkan data yang ada, kota yang
                        mendapatkan
                        pendapatan terbanyak berasal dari Canada, Southeast, dan Northeast. -->
                    </p>
                    ...
                    Highcharts.chart('barchart', {
                        ...
                        title: {
                            text: 'Data Pendapatan Penjualan Kota'
                        },
                        subtitle: {
