        ...
        <div class="container-fixed page-body-wrapper">
            <div class="content-wrapper" style="background-color: white;">
                <div class="page-header">
                    <h3 class="page-title" style="font-size:20px;"> <br> Data Metode Pengiriman </h3>
                </div>
                <div class="row">
                    <div id="barchart" class="grafik"></div>
                    <p class="highcharts-description" style="font-size:14px; text-align:center;"><br>
                        <!-- Berikut merupakan grafik untuk menampilkan frekuensi penggunaan metode pengiriman produk.
                        Pengiriman yang sering digunakan yaitu Cargo Transport 5 dengan mengirimkan sebanyak 36 produk. -->
                    </p>
