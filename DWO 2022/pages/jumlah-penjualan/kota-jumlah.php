        ...
        <div class="container-fixed page-body-wrapper">
            <div class="content-wrapper" style="background-color: white;">
                <div class="page-header">
                    <h3 class="page-title" style="font-size:20px;"> <br> Data Order Penjualan Berdasarkan Kota </h3>
                </div>
                <div class="row">
                    <div id="barchart" class="grafik"></div>
                    <p class="highcharts-description" style="font-size:14px; text-align:center;"><br>
                        <!-- Berikut merupakan grafik untuk menampilkan jumlah order berdasarkan Kota.
                        Jumlah order pada setiap kota berasal dari penjualan setiap toko. Berdasarkan data
                        tersebut, kota yang telah menjualkan banyak produk yaitu Southeast, Central, dan Germany. -->
