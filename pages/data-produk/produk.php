        ...
        <div class="container-fixed page-body-wrapper">
            <div class="content-wrapper" style="background-color: white;">
                <div class="page-header">
                    <h3 class="page-title" style="font-size:20px;"> <br> Data Produk </h3>
                </div>
                <div class="row">
                    <div id="barchart" class="grafik"></div>
                    <p class="highcharts-description" style="font-size:14px; text-align:center;"> <br>
                        <!-- Berikut merupakan grafik untuk menampilkan banyak produk yang terjual. Produk yang banyak
                        terjual berasal dari Mountain-100 Black berjumlah 24 produk, Road-650 Red berjumlah 16 produk,
                        dan Road-650 Red berjumlah 10 produk. -->
                    </p>
