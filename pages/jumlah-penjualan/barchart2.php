...
<head>
    ...
    <title>Dashboard WH Adventure Works</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <p class="highcharts-description">
                    Berikut merupakan grafik untuk menampilkan jumlah order dari setiap Toko.
                </p>
                <!-- /.container-fluid -->
            </div>
            <!-- End of Main Content -->
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Dashboard WHAdventure</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
