...
<body>
    <?php
  //data barchart
  include 'datatahunorder.php';
  include 'datatahunorder2.php';

  $datatahunorder = json_decode($datatahunorder, TRUE);
  $datatahunorder2 = json_decode($datatahunorder2, TRUE);
        ...
        <div class="container-fixed page-body-wrapper">
            <div class="content-wrapper" style="background-color: white;">
                <div class="page-header">
                    <h3 class="page-title" style="font-size:20px;"> <br> Data Order Penjualan Berdasarkan Tahun </h3>
                </div>
                <div class="row">
                    <div id="barchart" class="grafik"></div>
                    <p class="highcharts-description" style="font-size:14px; text-align:center;"><br>
                        <!-- Berikut merupakan grafik untuk menampilkan jumlah order produk per-tahun. Jumlah order produk
                        terbanyak berasal dari tahun 2003, 2002, 2004. -->
                    </p>
                    ...
                    Highcharts.chart('barchart', {
                        ...
                        title: {
                            text: 'Data Order Penjualan Per-Tahun'
                        },
                        subtitle: {
                        ...
                        series: [{
                            ...
                            colorByPoint: true,
                            data: [
                                <?php foreach ($datatahunorder as $data) : ?> {
                                    name: '<?= $data["name"]; ?>',
                                    y: <?= $data["total"]; ?>,
                                    drilldown: '<?= $data["name"]; ?>'
                                },
