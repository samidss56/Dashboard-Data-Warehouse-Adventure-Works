        ...
        <div class="container-fixed page-body-wrapper">
            <div class="content-wrapper" style="background-color: white;">
                <div class="page-header">
                    <h3 class="page-title" style="font-size:20px;"> <br> Data Pembelian Customer </h3>
                </div>
                <div class="row">
                    <div id="barchart" class="grafik"></div>
                    <p class="highcharts-description" style="font-size:14px; text-align:center;"> <br>
                        <!-- Berikut merupakan grafik untuk menampilkan 3 TOP customer yang membeli produk terbanyak.
                        Customer dengan ID 4 melakukan pembelian sebanyak 12 produk, customer dengan ID 18 melakukan
                        pembelian sebanyak 5 produk, dan customer dengan ID 65 melakukan pembelian sebanyak 4 produk. -->
                    </p>
